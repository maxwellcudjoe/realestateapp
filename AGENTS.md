...
When creating or editing notes, use file write tools to persist them to disk.
When querying, read `obsidian/index.md` first, then drill into relevant pages.
Always append to `obsidian/log.md` — never overwrite it.
